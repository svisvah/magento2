<?php
/**
 * Vendor Grid Record Delete Controller.
 * @category  Vendor
 * @package   Vendor_Grid
 * @author    Vendor
...
use Vendor\Grid\Model\ResourceModel\Grid\CollectionFactory;
...
class MassDelete extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Vendor_Grid::row_data_delete');
    }
}
